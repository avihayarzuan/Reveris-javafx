...
public class DefineConstants {
  ...
  /**
   * set the constants of the game for all classes to run
   * @param size the board one dimension size
   * @param first the first player color
   * @param second the second player color
   */
  public static void setConstants(int size, Color first, Color second) {
    BOARD_SIZE = size;
    FIRST_COLOR = first;
    SECOND_COLOR = second;
